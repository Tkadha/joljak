...
#define WIN32_LEAN_AND_MEAN             // Í±∞Ïùò ?¨Ïö©?òÏ? ?äÎäî ?¥Ïö©?Ä Windows ?§Îçî?êÏÑú ?úÏô∏?©Îãà??
// Windows ?§Îçî ?åÏùº:
#define NOMINMAX

#include <windows.h>

// CÔøΩÔøΩ ÔøΩÔøΩ≈∏ÔøΩÔøΩ ÔøΩÔøΩÔø?ÔøΩÔøΩÔøΩÔøΩÔøΩ‘¥œ¥ÔøΩ.
#include <stdlib.h>
#include <malloc.h>
#include <memory.h>
#include <tchar.h>
...
// TODO: ÔøΩÔøΩÔøΩŒ±◊∑ÔøΩÔøΩÔøΩ ÔøΩ øÔøΩÔøΩÔøΩ ÔøΩﬂ∞ÔøΩ ÔøΩÔøΩÔøΩÔøΩÔø?ÔøΩÔøΩÔøΩ‚ø°ÔøΩÔøΩ ÔøΩÔøΩÔøΩÔøΩÔøΩ’¥œ¥ÔøΩ.
...
namespace Vector3
{
	...
	inline float LengthSq(const XMFLOAT3& v)
	{
		...
		XMVECTOR lengthSqVec = XMVector3LengthSq(vec); // Í∞??±Î∂Ñ ?úÍ≥±?©Ïùò X ?±Î∂ÑÎß?Í∞Ä?∏Ïò¥
