...
ID3D12RootSignature* CStandardShader::CreateRootSignature(ID3D12Device* pd3dDevice)
{
	...
	pd3dDescriptorRanges[0].Init(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 7, 7, 0); // t6-t12: Albedo, Specular, Normal 등
	pd3dDescriptorRanges[1].Init(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 4, 3, 0); // t3: Shadow Map
