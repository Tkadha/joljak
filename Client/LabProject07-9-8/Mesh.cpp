	...
	m_nPositions(other.m_nPositions)
{
	...
	if (other.m_ppd3dSubSetIndexBuffers && other.m_nSubMeshes > 0) {
		// Raw Æ÷ÀÎÅÍ ¹è¿­À» º¹»ç (ComPtr¸¦ »ç¿ëÇÏÁö ¾Ê´Â´Ù´Â °¡Á¤)
		// ÀÌ °æ¿ì ComPtr¸¦ »ç¿ëÇÏÁö ¾Ê´Â´Ù¸é ¼ö¸í °ü¸®°¡ ¸Å¿ì º¹ÀâÇØÁý´Ï´Ù.
		...
		for (UINT i = 0; i < other.m_nSubMeshes; ++i) {
			...
			if (m_ppd3dSubSetIndexBuffers[i]) m_ppd3dSubSetIndexBuffers[i]->AddRef(); // ÂüÁ¶ Ä«¿îÆ® Áõ°¡
